...
[Eager loading](https://laravel.com/docs/9.x/eloquent-relationships#eager-loading) relationships in Laravel makes it
...
trick. [But that does not work](https://laravel.com/docs/9.x/eloquent-relationships#constraining-eager-loads).
